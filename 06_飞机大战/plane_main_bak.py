...
class Hero(GameSprite):
    ...
    def update(self):
        ...
        new_rect = self.rect
        if self.name == 1:
            super().__init__("./images/me%d.png" % 2)
            self.speed = 0
            self.name = 2
        elif self.name == 2:
            super().__init__("./images/me%d.png" % 1)
            self.speed = 0
            self.name = 1

        # 英雄毁灭
        elif self.name == 3:
            super().__init__("./images/me_destroy_%d.png" % self.i)
